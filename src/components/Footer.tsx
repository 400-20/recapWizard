    ...
    <footer className="bg-gray-900 text-white py-12">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-xl pacifico-regular font-light mb-4">Recap Wizard</h3>
            <p className="text-gray-400">Transforming meetings with AI-powered insights.</p>
          </div>
          <div>
            <h4 className="text-lg pacifico-regular font-light mb-4">Quick Links</h4>
          ...
          <div>
            <h4 className="text-lg pacifico-regular font-light mb-4">Legal</h4>
            <ul className="space-y-2">
              <li>
          ...
          <div>
            <h4 className="text-lg pacifico-regular font-light mb-4">Connect With Us</h4>
        ...
        <div className="mt-8 pt-8 border-t border-gray-800 text-center">
          <p className="text-gray-400">&copy; 2025 Recap Wizard. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
